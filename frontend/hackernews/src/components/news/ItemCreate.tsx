...
const ItemCreate = () => {
  ...
  const [descendant, setDescendant] = useState<number | "">(0);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const newItem: Item = {
      ...
      url: url,
      descendant: descendant === "" ? 0 : descendant,
      kids: [],
    };
  ...
  return (
    <div>
      <form
        ...
        action=""
        className="container mx-auto mx-w-auto md:p-8 border rounded-md"
      >
        <h2 className="text-2xl text-center my-3 md:4xl font-bold"> Create Item </h2>
        <div>
          <label
            htmlFor="title"
        ...
        <div className="py-2">
          <label
            ...
            className="block text-sm font-medium text-gray-700"
          >
            Specify a correct URL (e.g https://hackernews.com/items)
          </label>
          <input
            type="text"
            id="url"
